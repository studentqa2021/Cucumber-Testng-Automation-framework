	...
	public static void verifyLink(String urlLink) {
		...
		try {
			...
			if (httpConn.getResponseCode() == 200) {
				System.out.println("Good link >> "+urlLink + " - " + httpConn.getResponseMessage());
			}
			if (httpConn.getResponseCode() == 404) {
				System.err.println("------------ Broken link found ------------------------");
				System.err.println("Broken link>> "+urlLink + " - " + httpConn.getResponseMessage());
				System.err.println(" ");
			}
		}
